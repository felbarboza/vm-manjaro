CREATE OR REPLACE PROCEDURE MGCUSTOM.PRC_CAR_EXTRATO_COMPLETO_EMP ( retorno IN OUT mgrel.pck_resultado.RESULT
                                                              ...
                                                              , v_tcon            VARCHAR2
                                                              , v_tcon1           VARCHAR2
                                                              , v_tipoindice      VARCHAR2
                                                              , v_data_base       VARCHAR2
                                                              , cod_est           NUMBER
                                                              , cod_cto           NUMBER
                                                              , cod_blc           NUMBER
                                                              , cod_uni           NUMBER
                                                              ...
                                                              , v_tra             CHAR
                                                              , v_descap_sac      CHAR
                                                              , v_mostra_cheque   CHAR
                                                              , p_cons_taxa       CHAR
                                                              , p_cons_bonif      CHAR
                                                              , p_parc_caucao     CHAR
                                                              , p_vl_corrigido    CHAR
                                                              , p_investidor      CHAR
                                                              , p_cons_confdivida CHAR
                                                              , p_agn_in_codigo   NUMBER
                                                              , p_par_secur       CHAR
                                                              , p_cons_jr_tp_sac  CHAR) AS
