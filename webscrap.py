...
for i in range(0,2996):
  ...
  try:
    try:
      ...
      dict_list_fisica.append(dict_dados_proposta_fisica)
    except:
      dict_dados_juridica={
      'nome' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Nome').text,
      'nomeFantasia' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Fantasia').text,
      'Ch_TipoPessoa' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_Ch_TipoPessoa').text,
      'St_Cnpj' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Cnpj').text,
      'St_Cei' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Cei').text,
      'St_InscrEstadual' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_InscrEstadual').text,
      'St_InscrMunic' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_InscrMunic').text,
      'St_Nire' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Nire').text,
      'St_Nire_Sigla' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Nire_Sigla').text,
      'Dt_Nire_DtRegistro' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_Dt_Nire_DtRegistro').text,
      'St_Email' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_St_Email').text,
      'Mid_In_Codigo' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pMid_In_Codigo').text,
      'Ch_Objetivo' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_Ch_Objetivo').text,
      'Bo_MalaDireta' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_Bo_MalaDireta').text,
      'Bo_Corresp' : driver.find_element_by_id('cbpRelatorio_pnlDadosPessoaisRel_pPro_Bo_Corresp').text,
      'Ban_In_Numero' : driver.find_element_by_id('cbpRelatorio_pnlDadosBancariosRel_pBan_In_Numero').text,
      'St_Agencia' : driver.find_element_by_id('cbpRelatorio_pnlDadosBancariosRel_pPro_St_Agencia').text,
      'St_ContaCorrente' : driver.find_element_by_id('cbpRelatorio_pnlDadosBancariosRel_pPro_St_ContaCorrente').text
      }
      dict_list_juridica.append(dict_dados_juridica)
  except:
    lista_dos_que_nao_foram.append(i)
...
print(lista_dos_que_nao_foram)
df = pd.DataFrame(dict_list_fisica)
df2 = pd.DataFrame(dict_list_juridica)
df.to_excel('./testePropostas.xlsx')
df2.to_excel('./teste2Propostas.xlsx')
